...
void MainWindow::ReadSettings() {
    ...
    ui->oglView->line_red = settings.value("line_red", -1).toFloat();
    ui->oglView->line_green = settings.value("line_green", -1).toFloat();
    ui->oglView->line_blue = settings.value("line_blue", -1).toFloat();
    ui->oglView->point_red = settings.value("point_red", -1).toFloat();
    ui->oglView->point_green = settings.value("point_green", -1).toFloat();
    ui->oglView->point_blue = settings.value("point_blue", -1).toFloat();
    ui->oglView->point_setup = settings.value("point_setup", -1).toInt();
    ui->oglView->point_size = settings.value("point_size", -1).toInt();
    ui->oglView->strip = settings.value("line_strip", -1).toInt();
    ui->oglView->line_width = settings.value("line_setup", -1).toInt();
    ui->oglView->kProjection = settings.value("projection", -1).toInt();
}
